...
// 프롬포트 창으로 입력받아 그 값을 프로퍼티로 사용하는 경우
// 이때 생성자 함수로 객체를 정의하여 사용할 수 있다.

function makeUser(name,age){
    return{
        name : name,
        age : age   // 변수와 프로포티 이름이 같다
    }
}

let user1 = makeUser('장소윤',22);
