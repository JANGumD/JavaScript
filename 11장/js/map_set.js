...
// 키나 값을 가져오는 메서드는 이터러블 객체를 반환시켜 준다.
...
// 셋 Set()
// 셋은 키가 없다. 여러 개의 값을 모아 놓은 것
// -> 배열이랑 같지만, 값이 중복되지 않는다.
...
let numSet3 = new Set([1,2,3,1,4,1,3,5,1,4]);
...
// values 메서드를 사용해 값을 가져와 
// for of 반복문으로 language 셋에 있는 값을 출력하시오
